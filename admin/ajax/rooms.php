<?php
    ...
    if(isset($_POST['get_all_rooms']))
    {
        ...
        while($row = mysqli_fetch_assoc($res))
        {
            ...
            {
                $status = "
                    <button class='btn btn-dark btn-sm shadow-none' onclick='toggle_status($row[id],0)'>
                        Active
                    </button>
                ";
            }
                ...
                {
                    $status = "
                        <button class='btn btn-warning btn-sm shadow-none' onclick='toggle_status($row[id],1)'>
                            Inactive
                        </button>
                    ";
                }
